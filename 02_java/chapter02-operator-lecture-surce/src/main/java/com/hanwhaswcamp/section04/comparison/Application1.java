package com.hanwhaswcamp.section04.comparison;
...
//        System.out.println("bool1이 bool2보다 작은거나 같은지 비교 : " + (bool1 <= bool2));
        ...
        System.out.println("str1과 str2가 같은지 비교 : " + (str1 == str2));   // 주소 값 비교
        System.out.println("str1과 str2가 같지 않은지 비교 : " + (str1 != str2));        // 주소 값 비교
        System.out.println("str1과 str2가 같지 않은지 비교 : " + (str1.equals(str2)));        // 문자열 값 비교
        System.out.println("str1과 str2가 같지 않은지 비교 : " + !(str1.equals(str2)));        // 문자열 값 비교
